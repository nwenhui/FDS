        ...
        return (  
            <Dialog open={this.state.edit} >
                ...
                <DialogContent>
                  <form>
                    <FormControl>
                      <TextField disabled label="Start Date" type="date" onChange={this.setStartDate.bind(this)} defaultValue={this.state.start} variant="outlined" />
                    </FormControl>
                    <FormControl>
                      <TextField label="End Date" type="date" onChange={this.setEndDate.bind(this)} defaultValue={this.state.end} variant="outlined" />
                    </FormControl>
                    <FormControl>
