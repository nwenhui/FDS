...
class RestaurantSignup extends Component {
    ...
    setRestaurantName = (event) => {
        ...
        this.setState({ restaurantName: value}, () => {console.log(this.state.restaurantName)});
    }

    setMinSpending = (event) => {
        var value = Number(event.target.value);
        this.setState({ minSpending: value}, () => {console.log(this.state.minSpending)});
    }

    setAddress = (event) => {
        var value = event.target.value;
        this.setState({ address: value}, () => {console.log(this.state.address)});
    }
    ...
    handleSubmit(event) {
        ...
        authenticationService.restaurantSignup(this.state.restaurantName, this.state.minSpending, this.state.address)
        .then((data) => {
            this.setState({ error: false, success: true }, () => console.log(this.state.error));
        })
        .catch((error) => {
